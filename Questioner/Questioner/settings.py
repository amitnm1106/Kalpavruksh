...
SECRET_KEY = 'ya!b=_=b*f=^o8)d3_x=cn6h*1-l^=e(3akri8glu88yji*@y7'
...
MIDDLEWARE = [
    ...
    'Questioner.middleware.QuestionerMiddleware',
]
...
STATIC_ROOT = os.path.join(BASE_DIR,"server_static_file")
STATIC_URL = '/static/'
